...
public class MnemonicPrayer extends TargetedSpell{
        ...
        if (ch.alignment == Char.Alignment.ALLY){
            ...
            for (Buff b : ch.buffs()){
                ...
                if (b instanceof AscendedForm.AscendBuff
                        ...
                        || b instanceof PowerOfMany.PowerBuff || b instanceof com.shatteredpixel.shatteredpixeldungeon.actors.hero.spells.BeamingRay.BeamingRayBoost || b instanceof LifeLink || b instanceof LifeLinkSpell.LifeLinkSpellBuff
