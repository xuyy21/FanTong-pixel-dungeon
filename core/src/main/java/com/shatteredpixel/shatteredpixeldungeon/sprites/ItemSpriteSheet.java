...
public class ItemSpriteSheet {
	...
	public static final int RATCROWN       = MISC_CONSUMABLE +25;
	...
	public static final int RUNICGAUNTLE    = WEP_TIER2+6;
	public static final int SLING          	= WEP_TIER2+7;
	static{
		...
		assignItemRect(RUNICGAUNTLE,    12, 16);
		assignItemRect(SLING,          	14, 15);
	}
	...
	public static final int POTATOGUN		= WEP_TIER3+7;
	static{
		...
		assignItemRect(POTATOGUN,		15, 15);
	}
	...
	public static final int RING_JET    	= RINGS+12;
	static {
    ...
    public static final int ARTIFACT_KEY        = ARTIFACTS+25;
    static{
		...
		assignItemRect(ARTIFACT_PAW,      	16, 14);
	...
	public static final int GARLAND       	= TRINKETS+17;
	public static final int PIZOELECT 		= TRINKETS+18;
	public static final int SPROUTEDPOTATO  = TRINKETS+19;
	static{
	...
	public static final int PIRANHAPOT   	= BREWS+6;
	...
	static{
		...
		assignItemRect(PIRANHAPOT,14, 13);
	}
	...
	public static final int EX_ENCHANTMENT	= SPELLS+4;
	...
	public static final int REMOVE_MISSILES_CURSE	= SPELLS+9;
	...
	public static final int GOO_STYLUS      = SPELLS+14;
	public static final int COOKWARE      	= SPELLS+15;
	...
	static{
		...
		assignItemRect(EX_ENCHANTMENT,  13, 13);
		...
		assignItemRect(REMOVE_MISSILES_CURSE,	10, 15);
	...
	private static  final int COOKED_FOOD	=								xy(1, 35);
	...
	public static class Icons {
		...
		public static final int RING_SKILL     	= RINGS+12;
		static {
