...
public class MissileSprite extends ItemSprite implements Tweener.Listener {
	...
	static {
		...
		ANGULAR_SPEEDS.put(Xuanmi.class,       	0);
		ANGULAR_SPEEDS.put(WandOfGnollKing.MirrorGnollSprite.GnollSpear.class,	0);
		
		ANGULAR_SPEEDS.put(SpiritBow.SpiritArrow.class,       0);
		ANGULAR_SPEEDS.put(ScorpioSprite.ScorpioShot.class,   0);
		ANGULAR_SPEEDS.put(HolyLance.HolyLanceVFX.class,      0);
		ANGULAR_SPEEDS.put(com.shatteredpixel.shatteredpixeldungeon.runes.spells.HolyLance.HolyLanceVFX.class,      0);
