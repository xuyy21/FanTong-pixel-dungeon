...
import com.shatteredpixel.shatteredpixeldungeon.runes.spells.RunicBoom;
...
public class v0_4_X_FTChanges {
    public static void addAllChanges( ArrayList<ChangeInfo> changeInfos ){
        add_v0_4_13_Changes(changeInfos);
        add_v0_4_12_Changes(changeInfos);
    ...
    public static void add_v0_4_12_Changes(ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.EX_ENCHANTMENT), "加强EX附魔与EX刻印",
                "部分EX附魔与EX刻印得到加强，以使其变得更加实用。\n\n" +
                        "死生恒常附魔：现在可以从所有生物的死亡中获得点数，而不是仅能通过带有此附魔的武器杀死敌人。该附魔给予护盾量提高67%。该附魔现在还可以对免疫秒杀的敌人造成伤害。但是触发概率添加上限为61.8%\n\n" +
                        "花开富贵附魔：现在生效时必定生成植物怪，然后再随机生成额外的种子与符石。同时触发概率提高33%。\n\n" +
                        "磐石守卫附魔：不再是使用溢出的伤害，而是击杀一击的全部伤害。而且磐石守卫的防御力提高大约67%，信念护体挑战下的提升则是约100%。\n\n" +
                        "阴拒阳留附魔：触发概率提高33%。\n\n" +
                        "不动明王刻印：添加护甲等级调整值，我说我之前忘了你信吗。现在高级护甲会提高明王怒气的积累速度与爆发时的伤害。\n\n" +
                        "镜花水月刻印：该刻印制造的镜像由原本的施加众矢之的改为符术幻影同款的吸引视野内敌人，而且视野增大为8格。但是冷却提升10回合。"));
        ...
        changes.addButton(new ChangeButton(RunicBoom.INSTANCE.icon(), "符文爆发",
                "调整符文爆发的代码，使其不会炸掉目标死亡后的掉落物。"));
