...
import com.shatteredpixel.shatteredpixeldungeon.runes.spells.Blight;
...
public class Dungeon {
	...
	public static void observe(){
		...
		if (Dungeon.hero.buff(Blight.Blighting.class) != null)
			dist *= Blight.Blighting.viewMultiplier;
