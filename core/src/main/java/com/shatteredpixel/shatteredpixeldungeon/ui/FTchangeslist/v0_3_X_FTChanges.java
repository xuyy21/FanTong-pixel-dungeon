...
public class v0_3_X_FTChanges {
    ...
    public static void add_v0_3_4_Changes( ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.EX_ENCHANTMENT), "EX附魔结晶",
                "这个强大的魔法结晶可以将装备上已有的正面附魔或正面刻印转化为EX附魔或EX刻印。EX附魔与EX刻印通常比一般的附魔与刻印更加强大，但是如果是本身就很实用的附魔与刻印，你可能要思量一下是否转化。" +
