...
public enum Talent {
	...
	//NightWing T3
	SHARED_RINGS(91, 3), SHARED_TRAP(92, 3), CLOAK_POWERS(93, 3),
	//Smoke Bomb T4
	...
	//FLETCHER T3
	FLETCH_TECH(123, 3), MELEE_BACKUP(124, 3), FLETCH_RECIPE(125, 3),
	//Spectral Blades T4
...
//		}
	...
	public static void onFoodEaten( Hero hero, float foodVal, Item foodSource ){
		...
		if (hero.hasTalent(MEAL_WILL)){
			float factor = Math.min(0.75f * foodVal / Hunger.STARVING + 0.25f, 1.0f);
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case FREERUNNER:
				...
				break;
			case NIGHTWING:
				Collections.addAll(tierTalents, SHARED_RINGS, SHARED_TRAP, CLOAK_POWERS);
				break;
			case SNIPER:
			...
			case WARDEN:
				...
				break;
			case FLETCHER:
				Collections.addAll(tierTalents, FLETCH_TECH, MELEE_BACKUP, FLETCH_RECIPE);
				break;
			case CHAMPION:
